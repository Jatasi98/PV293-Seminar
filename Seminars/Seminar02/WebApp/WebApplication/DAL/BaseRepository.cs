...
{
    public class BaseRepository : IdentityDbContext<AppUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>().HasData(
                new Customer { Id = 1, CreatedOnUTC = seedTime, FirstName = "Demo", LastName = "Customer", Email = "demo@example.com", AppUserId = null }
            );
        }
    }
}