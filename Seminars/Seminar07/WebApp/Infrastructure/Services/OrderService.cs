...
public class OrderService : IOrderService
{
    ...
    public OrderService(WebAppDbContext db)
    {
        _db = db;
    }

    public async Task<List<OrderDTO>?> GetOrders(CustomerDTO user)
    {
    ...
    public async Task<OrderDTO?> GetOrder(CustomerDTO user, int orderId)
    {
        var customerId = await _db.Customers
            .Where(c => c.Id == user.Id)
            .Select(c => c.Id)
